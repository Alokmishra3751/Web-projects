!(function i(n, r, l) {
...
})(
    {
        ...
        2: [
            ...
            { "@babel/runtime/helpers/interopRequireDefault": 10, "@babel/runtime/helpers/typeof": 11 },
        ],
        3: [
            function (e, t, o) {
                "use strict";
                var i = e("@babel/runtime/helpers/interopRequireDefault"),
                    ...
                    s = i(e("@babel/runtime/helpers/classPrivateFieldGet")),
                    u = e("../../constants"),
                    c = e("../../lib/utils");
                function d(e, t, o) {
                ...
                function w(e) {
                    var o = this,
                        t = Array.from(e.querySelectorAll(".validate-required")).filter(function (t) {
                            return (
                                d(o, x, a).call(o, t) &&
                                "input, select, textarea".split(", ").find(function (e) {
                                    e = t.querySelector(e);
                        ...
                        i = 0 === t.length;
                    return (
                        e.querySelectorAll(".ow-invalid").forEach(function (e) {
                            e.classList.remove("ow-invalid");
                        }),
                        i ||
                            t.forEach(function (e) {
                                e.classList.add("ow-invalid");
                            }),
                        i
                    );
                }
                ...
                new (function e() {
                    ...
                    (0, n.default)(this, e),
                        ...
                        y.set(this, {
                            ...
                            value: function () {
                                (0, r.default)(a, f, [
                                    (0, s.default)(a, p).checkoutLogin,
                                    (0, s.default)(a, p).customerShippingDetails,
                                    (0, s.default)(a, p).customerBillingDetails,
                                    
                                    (0, s.default)(a, p).orderReview,
                                    (0, s.default)(a, p).orderCheckoutPayment,
                                ]);
                            },
                        }),
                        m.set(this, {
                            ...
                            value: function () {
                                var e, t;
                                jQuery((0, s.default)(a, p).body).on("updated_checkout", (0, s.default)(a, v)),
                                    null === (e = (0, s.default)(a, p).formActions) || void 0 === e || (null !== (t = e.querySelector(".button.prev")) && void 0 !== t && t.addEventListener("click", (0, s.default)(a, h))),
                                    null === (t = (0, s.default)(a, p).formActions) || void 0 === t || (null !== (t = t.querySelector(".button.next")) && void 0 !== t && t.addEventListener("click", (0, s.default)(a, h)));
                            },
                        }),
                        v.set(this, {
                            writable: !0,
                            value: function (e) {
                                var t;
                                null === (t = (0, s.default)(a, p).orderCheckoutPayment) ||
                                    void 0 === t ||
                                    (null !== (t = t.querySelectorAll("input[name=payment_method]")) &&
                                        void 0 !== t &&
                                        t.forEach(function (e) {
                                            e.addEventListener("click", (0, s.default)(a, b));
                                        }));
                            },
                        }),
                        b.set(this, {
                            ...
                            value: function (e) {
                                var t = e.target;
                                1 < document.querySelectorAll(".payment_methods input.input-radio").length &&
                                    ((e = document.querySelector(".payment_box.".concat(t.getAttribute("id")))),
                                    !0 !== t.checked || (0, c.visible)(e)
                                        ? document.querySelectorAll(".payment_box").forEach(function (e) {
                                        ...
                                        : (document.querySelectorAll(".payment_box").forEach(function (e) {
                                          ...
                                          (0, c.slideDown)(e, 250)),
                                    t.getAttribute("data-order_button_text")
                                        ? ((0, s.default)(a, p).placeOrder.value = t.getAttribute("data-order_button_text"))
                                        : ((0, s.default)(a, p).placeOrder.value = (0, s.default)(a, p).placeOrder.getAttribute("data-value")));
                            },
                        }),
                        h.set(this, {
                            writable: !0,
                            value: function (e) {
                                ...
                                var t = e.currentTarget,
                                    o = (0, s.default)(a, p).formActions.querySelector(".button.next"),
                                    i = (0, s.default)(a, p).formActions.querySelector(".button.prev"),
                                    n = t.getAttribute("data-action"),
                                    e = Number.parseInt((0, s.default)(a, p).formActions.getAttribute("data-step")),
                                    r = e + 1,
                                    l = e - 1,
                                    t = u.options.is_logged_in;
                                d(a, g, w).call(a, (0, s.default)(a, f)[e]) &&
                                    ((0, s.default)(a, p)
                                        .checkoutTimeline.querySelectorAll(".active")
                                        .forEach(function (e) {
                                            e.classList.remove("active");
                                        }),
                                    "next" === n
                                        ? ((0, s.default)(a, p).formActions.setAttribute("data-step", r),
                                          (0, c.fadeOut)((0, s.default)(a, f)[e], {
                                              display: "inline-block",
                                              callback: function () {
                                                  (0, c.fadeIn)((0, s.default)(a, f)[r]);
                                              },
                                          }),
                                          document.querySelector("#timeline-".concat(r)).classList.toggle("active"))
                                        : "prev" === n &&
                                          ((0, s.default)(a, p).formActions.setAttribute("data-step", l),
                                          (0, c.fadeOut)((0, s.default)(a, f)[e], {
                                              display: "inline-block",
                                              callback: function () {
                                                  (0, c.fadeIn)((0, s.default)(a, f)[l]);
                                              },
                                          }),
                                          document.querySelector("#timeline-".concat(l)).classList.toggle("active")),
                                    (e = (0, s.default)(a, p).formActions.getAttribute("data-step")),
                                    ((1 == t && 1 == e) || (0 == t && ((0 == e && 1 === u.options.login_reminder_enabled) || (1 == e && 0 === u.options.login_reminder_enabled))) ? (0, c.fadeOut) : (0, c.fadeIn))(i, {
                                        display: "inline-block",
                                    }),
                                    0 == t && ((0 == e && 1 === u.options.login_reminder_enabled) || (1 == e && 0 === u.options.login_reminder_enabled)) ? (o.value = u.options.no_account_btn) : (o.value = u.options.next),
                                    3 == e
                                        ? ((0, s.default)(a, p).checkoutForm.classList.remove("processing"), (0, c.fadeIn)((0, s.default)(a, p).checkoutCoupon), (0, c.fadeOut)(o, { display: "inline-block" }))
                                        : ((0, s.default)(a, p).checkoutForm.classList.add("processing"), (0, c.fadeOut)((0, s.default)(a, p).checkoutCoupon), (0, c.fadeIn)(o, { display: "inline-block" })));
                            },
                        }),
                        (0, s.default)(this, l).call(this),
                        (0, s.default)(this, y).call(this),
                        (0, s.default)(this, m).call(this);
                })();
            },
            {
                "../../constants": 1,
